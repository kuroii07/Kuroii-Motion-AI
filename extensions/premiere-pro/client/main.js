...
const i18n = {
  ...
  "en-US": {
    ...
    "status.readOnly": "Read-only preview; PR project will not be changed",
    "mode.context": "Context",
    "mode.actions": "Actions",
    "mode.log": "Log",
    "card.context": "Sequence Context",
...
function hostPayload(status) {
  return {
    ...
    context: {
      activeSequence: { name: previewContext.sequence },
      selection: []
    }
  };
}
...
function renderContent() {
  document.getElementById("content").innerHTML = [
    ...
    "<dt>" + t("field.sequence") + "</dt><dd>" + previewContext.sequence + "</dd>",
